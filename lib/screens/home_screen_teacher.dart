...
class theHomeScreen1 extends StatefulWidget {
  int y;
  theHomeScreen1(this.y);
  // {
  //   this.y=l;
  // }
  @override
...
class _theHomeScreenState extends State<theHomeScreen1> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text("Welcome , Mr Ouhda mohammed ", style: kHeadingextStyle),
